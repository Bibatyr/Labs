...
#Setting up Sounds
food_sound = pygame.mixer.Sound("C:\Сodes2\Lab08\eat.mp3")
game_over_theme_sound = pygame.mixer.Sound("C:\Сodes2\Lab08\game_over_theme.mp3")
pygame.mixer.music.load("C:\Сodes2\Lab08\Electric_Dreams.mp3")
...
main_menu_bg_load = pygame.image.load("C:\Сodes2\Lab08\Images\Forest_Landscape.jpg")
main_menu_bg = Button(main_menu_bg_load, 0, 0)
main_menu_play_load = pygame.image.load("C:\Сodes2\Lab08\Images\play_button_snake.png")
main_menu_play = Button(main_menu_play_load, (screen_width - main_menu_play_load.get_width()) / 2, 300)
main_menu_quit_load = pygame.image.load("C:\Сodes2\Lab08\Images\quit_button_snake.png")
main_menu_quit = Button(main_menu_quit_load, (screen_width - main_menu_quit_load.get_width()) / 2, 400)
main_menu_restart_load = pygame.image.load("C:\Сodes2\Lab08\Images\Restart_button_snake.png")
