...
seconds = pygame.image.load('Lab07\Images\Big-arrow.png')
minutes = pygame.image.load('Lab07\Images\small-arrow.png')
seconds = pygame.transform.scale(seconds, (50, 100))
minutes = pygame.transform.scale(minutes, (30, 60))

bg = pygame.image.load('Lab07\Images\mickey-clock.jpg')
